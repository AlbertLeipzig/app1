...
export const AllPlanets = () => {
  ...
  return (
    <section className="all-planets bg-green-700 py-10 mx-5">
      <h1 className="text-4xl text-center my-4 text-slate-200">All Planets</h1>
      <div className="loading">{loading && <h2>Loading...</h2>}</div>
      <div className="planets-container py-10 flex flex-wrap justify-center">
        {planets &&
          planets.map((planet) => (
            <article
              key={planet.name}
              className="border-2 border-purple-400 my-5 py-10 px-10 w-[300px] mx-auto text-slate-200 all-planets__article"
            >
